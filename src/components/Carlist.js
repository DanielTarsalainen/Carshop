...
function Carlist() {
  ...
  const columns = [
    ...
    { field: 'price', sortable: true, filter: true, width: 100 },
    {
      ...
      width: 100,
      cellRendererFramework: params => // props: voidaan renderöidä mikä tahnsa html elementti tai react komponentti
        // lähettää params valuen (tulee ag gridistä) SISÄLTÄÄ LINKIN AUTOON!
    ...
    },
    {
      ...
      field: '_links.self.href',
      width: 100,
      cellRendererFramework: params => //params.value == url
